CREATE OR REPLACE PACKAGE method4 AS
   ...
   ||              ------------------------------------------------------
   ||              These powerful queries can be confusing because of all the
   ||              quotation marks required to build strings inside strings.
   ||              Simplify your queries with the alternative quoting syntax
   ||              ("q" strings) and templating (REPLACE instead of concatenation):
   ||
   ...
   ||                 ));
   ||
   ||              c) PIVOT: Dynamically pivot the results based on the last two columns.
   ||              ------------------------------------------------------
   ||              This query... (TODO)
   ||
   ||              d) POLL_TABLE: Poll a table and return new rows until a condition is met.
   ||              ------------------------------------------------------
